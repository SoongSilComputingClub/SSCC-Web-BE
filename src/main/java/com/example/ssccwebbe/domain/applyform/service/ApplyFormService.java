...
public class ApplyFormService {
        ...
        public ApplyFormReadResponse read() {
                ...
                ApplyFormEntity form = applyFormRepository
        ...
        public ApplyFormReadResponse create(ApplyFormCreateOrUpdateRequest req) {
                ...
                return applyFormRepository
                                ...
                                .orElseGet(
                                                () -> {
                                                        // 지원서 자체가 없으면 신규 생성
                                                        ApplyFormEntity saved = applyFormRepository
                                                                        .save(ApplyFormEntity.create(preUser, req));
                ...
                List<ApplyFormInterviewTimeEntity> entities = req.interviewTimes().stream()
                                .sorted(
                                                Comparator.comparing(
                                                                ...
                                                                .thenComparing(
                                                                                ApplyFormCreateOrUpdateRequest.InterviewTime::startTime))
